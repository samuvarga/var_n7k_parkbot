...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/samuvarga/var_n7k_parkbot/generate) / [`Create new repository`](https://github.com/samuvarga/var_n7k_parkbot/generate). 
...
- `var_n7k_parkbot` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
